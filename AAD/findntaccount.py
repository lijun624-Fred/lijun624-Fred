...
# Preparation: 
# 1.Download the global user list, select NT account and email 2 columns, file name "exportglobalusers.csv"
# 2.Download cn user list, select user name column, file name "exportcnusers.csv"
